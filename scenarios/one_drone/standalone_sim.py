...
nbCF2 = 1
CF2_pose = [[0.0, 0.0, 0.0]]  # starts at origin
...
cf2_colors = [(0.0, 1.0, 0.0)] * nbCF2  # default green, updated each frame from LED
...
ax.set_title("One Drone — Crazyflie 2 (Circle + PID + Rainbow LED)")
ax.set_xlabel('X (m)')
ax.set_ylabel('Y (m)')
ax.set_zlabel('Z (m)')
