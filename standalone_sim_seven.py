...
import seven_drones_show.tp_algos_seven as tp_algos_seven  # edit this line to select your scenario
...
def update(frame):
    ...
    for i in range(nbTb3B):
        pose = tb3B_poses[:, i]
        default = (0.0, 0.0)
        vx, vy = get_async_cmd('tb3B', i, default, tp_algos_seven.tb3B_controller, 
    ...
    for i in range(nbTb3W):
        pose = tb3W_poses[:, i]
        default = (0.0, 0.0)
        vx, vy = get_async_cmd('tb3W', i, default, tp_algos_seven.tb3W_controller, 
                               i+1, pose.copy(), tb3B_snap, tb3W_snap, rmtt_snap, cf2_snap, rmep_snap, obs_poses, obs_sizes, [], clock_time)
    ...
    for i in range(nbRMTT):
        ...
        vx, vy, vz, trigger_land, led = get_async_cmd('rmtt', i, default, tp_algos_seven.rmtt_controller, 
                                                      i+1, pose.copy(), tb3B_snap, tb3W_snap, rmtt_snap, cf2_snap, rmep_snap, obs_poses, obs_sizes, clock_time)
    ...
    for i in range(nbCF2):
        ...
        vx, vy, z_dist, trigger_takeoff, trigger_land, led = get_async_cmd('cf2', i, default, tp_algos_seven.cf2_controller, 
                                                                           i+1, pose.copy(), tb3B_snap, tb3W_snap, rmtt_snap, cf2_snap, rmep_snap, obs_poses, obs_sizes, clock_time)
    ...
    for i in range(nbRMEP):
        pose = rmep_poses[:, i]
        default = (0.0, 0.0, 0.0)
        vx, vy, wz = get_async_cmd('rmep', i, default, tp_algos_seven.rmep_controller, 
                                   i+1, pose.copy(), tb3B_snap, tb3W_snap, rmtt_snap, cf2_snap, rmep_snap, obs_poses, obs_sizes, clock_time)
